...
export default class ComponentCha extends Component {
    state = {
      productDetail : {
        "id": 1,
        "name": "Adidas Prophere",
    ...
    setStateModal = (shoeDuocClick) => {
      this.setState({
        productDetail: shoeDuocClick
      })
    }
            ...
            return <div className='col-4 mt-2' key={index}>
                {/* <div className='card'>
                    ...
                    <div className='card-body'>
                        <h3>{item.name}</h3>
                        <h3>{item.price}</h3>
                        <button className='btn btn-dark' onClick={() => {this.setStateModal(item)}}>View detail</button>
                    </div>
                </div>  */}
                <ComponentCon item={product} setStateModal={this.setStateModal} />
            </div>
    })
  }
        ...
        return (
            <div className='container'>
                ...
                {/* <div className='card'>
                  ...
                  <h3>{this.state.productDetail.price}</h3>
